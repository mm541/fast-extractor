...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--cc=emcc --cxx=em++ --ar=emar --ranlib=emranlib --target-os=none --arch=x86_32 --enable-cross-compile --disable-x86asm --disable-inline-asm --disable-stripping --disable-programs --disable-doc --disable-everything --enable-avformat --enable-avcodec --enable-avutil --enable-demuxer='mov,mp4,m4a,3gp,3g2,mj2,matroska,webm,ogg,flv,avi,mpegts,flac,wav,mp3,aac' --enable-parser='h264,hevc,vp8,vp9,av1,aac,mpegaudio,opus,vorbis' --disable-pthreads --disable-w32threads --disable-os2threads --disable-network --disable-hwaccels --disable-decoders --disable-encoders --disable-muxers --disable-filters --disable-swscale --disable-swresample --extra-cflags='-O3 -s USE_PTHREADS=0' --extra-ldflags=-O3
prefix=/usr/local
...
CC_IDENT=emcc (Emscripten gcc/clang-like replacement + linker emulating GNU ld) 5.0.7 (263db4cffa6f9fc2ec514a70abac81362ea41849)
ARCH=x86
INTRINSICS=none
EXTERN_PREFIX=
CC=emcc
...
CFLAGS=  -O3 -s USE_PTHREADS=0 -std=c17 -fomit-frame-pointer -g -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wempty-body -Wmissing-prototypes -Wstrict-prototypes -Wunterminated-string-initialization -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -Wno-implicit-const-int-float-conversion -Wno-microsoft-enum-forward-reference -O3 -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=   -D__STDC_CONSTANT_MACROS -std=c++17 -fomit-frame-pointer -g -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -Wno-implicit-const-int-float-conversion -Wno-microsoft-enum-forward-reference -O3 -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
OBJCFLAGS=   -fomit-frame-pointer -g -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -Wno-implicit-const-int-float-conversion -Wno-microsoft-enum-forward-reference -O3 -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
ASFLAGS=  -O3 -s USE_PTHREADS=0 -g -Qunused-arguments
GLSLCFLAGS=
...
WINDRES=windres
DOXYGEN=doxygen
LDFLAGS= -O3  -Wl,-z,noexecstack -Wl,-rpath-link=:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil -Qunused-arguments
LDEXEFLAGS=
LDSOFLAGS=
