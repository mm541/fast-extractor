...
export class AudioExtractor {
    ...
    build_manifest() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.audioextractor_build_manifest(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
    ...
    get_extension() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.audioextractor_get_extension(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    get_mime() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.audioextractor_get_mime(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     * @param {any} handle
     * @param {boolean} build_manifest
     * @param {number} duration_sec
     */
    constructor(handle, build_manifest, duration_sec) {
        const ret = wasm.audioextractor_new(handle, build_manifest, duration_sec);
        if (ret[2]) {
